...
const TermsAndConditions = () => {
    ...
    return (
        ...
        <SafeAreaView>
            <ScrollView className="bg-gray-950 px-2">
                <View className="px-6 ">
                ...
                <View className="flex pt-4 items-start justify-between">
                    ...
                    <View className="mt-4 italic bg-white rounded-xl px-3 pb-10">
                        <Text className="text-justify text-sm mt-4 italic">
                        ...
                        <Text className="list text-justify ml-1 mr-1 text-sm mt-4">
                            ...
                            and the Privacy Policy. PLEASE ENSURE THAT YOU READ AND UNDERSTAND ALL THESE USER
                            TERMS BEFORE YOU USE THE SITE/APPLICATION. If You do not accept any of the User Terms,
                         ...
                         <Text className="text-teal-500 text-semibold">DEFINTIONS</Text>
                        ...
                        <Text className="block mt-4 ml-4 text-justify text-amber-900 text-sm">(1)  “Account“ : <Text className=" text-justify ml-1 mr-1 mt-4">shall mean the account created by the Customer on the Application for availing the
                            Services provided/facilitated by RAM Clinics. </Text></Text>

                        <Text className="block mt-4 ml-4 text-justify text-amber-900">(2)  “Applicable Laws“ : <Text style={styles.italic} className="text-justify ml-1 mr-1 text-sm mt-4">shall mean the account created by the Customer on the Application for availing the
                            Services provided/facilitated by RAM Clinics. </Text></Text>

                        <Text className="block mt-4 ml-4 text-justify text-amber-900">(3)  “Application“ : <Text style={styles.italic} className="text-justify ml-1 mr-1 text-sm mt-4"> shall mean our mobile application and/or website as updated by RAM Clinics from
                            time to time.  </Text></Text>

                        <Text className="block mt-4 ml-4 text-justify text-amber-900 text-sm">(4)  “Customer/ You/User" shall mean and include :<Text style={styles.italic} className="text-justify ml-1 mr-1 text-sm mt-4"> shall mean our mobile application and/or website as updated by RAM Clinics from
                            time to time.  </Text></Text>
                        ...
                        <Text className="block mt-5 ml-4 text-justify text-amber-900">(5)  “Force Majeure Event” <Text className="text-justify ml-1 mr-1 text-sm mt-4">
                            shall mean any and all events arising due to any cause beyond the
                            reasonable control of RAM Clinics. </Text></Text>
                        <Text className="block mt-4 ml-4 text-justify text-amber-900">(6)  “Registration Data”  <Text className="text-justify ml-1 mr-1 text-sm mt-4">
                        ...
                        <Text className="block mt-4 ml-4 text-justify text-amber-900">(7)  “Services”  <Text className="text-justify ml-1 mr-1 text-sm mt-4">
