                ...
                <View className="pb-8 px-6 pt-4">
                    ...
                    <View>
                        {approvals.map((approval) => (
                            <View key={approval.id} className="p-4 border border-amber-900 rounded-2xl w-full mt-4 bg-white">
                                <View className="flex-row justify-between items-center">
                                    <Text className="font-semibold">Approval ID: {approval.id}</Text>
                                    <AntDesign name="filetext1" size={24} color="#007BFF" />
                                </View>
                                <Text style={styles.invoiceText}>
                                    Total Amount: <Text style={styles.amount}>${approval.totalAmount}</Text>
                                </Text>
                                <Text style={styles.branchText}>Branch: {approval.branch}</Text>
                            </View>
                        ))}
                    </View>
                </View>
